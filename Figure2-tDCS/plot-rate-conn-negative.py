...
fig = pl.figure(figsize=(cm2inch(5), cm2inch(5)))
gs1 = gridspec.GridSpec(2, 1)
gs1.update(top=0.99,bottom=0.15,left=0.12,right=0.95,hspace=0.1,wspace=0.25)
ax1 = pl.subplot(gs1[0,0])
ax2 = pl.subplot(gs1[1,0])



ax1.plot(t,rates1,'-',color=c1,label=r'$\mathrm{sti \ (hyperpolarizing \ DC)}$')
...
pl.savefig("/home/hanlu/Desktop/Freiburg/tDCS-and-learning-NEST2.16/Figures/Figure2-tDCS/rate-conn-negative-DC.svg")
pl.show()

...
T = 'C://Users/han/Desktop/documents/tDCS-and-learning-NEST2.16/tDCS-only-np/EE_matrix/'
...
img = ax1.imshow(equalize(matrix,size=10)[0:150,0:150],vmin=vmin,vmax=vmax)
cax1 = fig.add_axes([0.75,0.2,0.01,0.72])
...
ax1.set_title(str(time/1000.)+"s",fontsize=8.)

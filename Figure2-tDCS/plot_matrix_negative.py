...
for idx in [0,1,2,3]:
    time = times[idx]
    matrix = np.load(T+"EE_matrix_step_"+str(time)+"_seed_0.npy")*10.
...
plt.savefig("/home/hanlu/Desktop/Freiburg/tDCS-and-learning-NEST2.16/Figures/Figure2-tDCS/matrix-negative-reduced.svg")
plt.show()

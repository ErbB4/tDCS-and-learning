...
memory_color= '#BFB1D3'
DCS_color= '#BBDB88'
alphas = np.hstack((np.ones(3),np.linspace(1,0,5),1,np.linspace(0,1,5),np.ones(3))) #control for alpha
...
T1 = "/home/hanlu/Desktop/Freiburg/tDCS-and-learning-NEST2.16/before-learning/unspecific/"
T2 = "/home/hanlu/Desktop/Freiburg/tDCS-and-learning-NEST2.16/during-learning/unspecific/"
T3 = "/home/hanlu/Desktop/Freiburg/tDCS-and-learning-NEST2.16/after-learning/unspecific/"


#####################plot before learning#####################
for ii in np.arange(2,8,2):
...
for ii in np.arange(10,15,2):
    rate = np.load(T3+"1000rates1_seed_"+str(ii)+".npy")
    conn = np.load(T3+"1000g1g1_seed_"+str(ii)+".npy")*10.
    ax3.plot(t,rate,red,alpha=alphas[ii],label=str(elec_field_strens[ii])+"mV")
    ax6.plot(t,conn,red,alpha=alphas[ii],label=str(elec_field_strens[ii])+"mV") 
...
ax1.text(825,24,'DC',fontsize=5,ha='center',va='bottom')
ax1.text(975,24,'ML',fontsize=5,ha='center',va='bottom')
ax2.text(825,24,'DC+ML',fontsize=5,ha='center',va='bottom')
ax3.text(825,24,'ML',fontsize=5,ha='center',va='bottom')
ax3.text(975,24,'DC',fontsize=5,ha='center',va='bottom')
ax4.set_ylabel(r'$\Gamma_\mathrm{engram}$')
...
plt.savefig("/home/hanlu/Desktop/Freiburg/tDCS-and-learning-NEST2.16/Figures/Figure3-unspecific-tDCS/uniform-tDCS-curves.svg")
plt.show()

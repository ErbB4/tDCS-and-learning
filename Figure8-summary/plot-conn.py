...
fig = plt.figure(figsize=(cm2inch(16), cm2inch(7)))
gs1 = gridspec.GridSpec(2, 3)
gs1.update(top=0.92,bottom=0.15,left=0.12,right=0.99,hspace=0.2,wspace=0.1)
...
ax4.plot(x2,overlap_conn2,'b--',label=r"$\mathrm{engram}$")
ax4.plot(x2,overlap_conn1,'b-',label=r"$\mathrm{engram + sti}$")
...
ax1.set_ylabel(r'$\Gamma_\mathrm{engram}$')
...
plt.savefig("final-conn-replace.svg")
plt.show()
